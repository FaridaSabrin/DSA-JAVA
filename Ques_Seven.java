// 1. Your are given a number following certain constraints.

// 2.The key Constraint is if the number is 5 digits long. it will contain all the digits from 1 to 5 without missing any and without repeating any.
//  e.g.23415 is a 5 digit long number containing all digits from 1 to 5 without missing and repeating any digit from 1 to 5.
// Take a look at few other valid number - 624135, 81456273 etc.
...
// e.g. for 426135(reading from right to left 5 is in place 1, 3 is in place 2, 1 is in place 3, 6 is in place 4, 2 is in place 5 and 4is in place 6).
